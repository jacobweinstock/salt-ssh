...
RUN apk --no-cache --update add python2=2.7.15-r0 openssl openssh py2-pip \
 && apk add --virtual build-dependencies python2-dev=2.7.15-r0 musl-dev gcc libffi-dev openssl-dev \
